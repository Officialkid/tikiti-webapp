...
import { UserIcon, LockClosedIcon, PhoneIcon, EnvelopeIcon } from "@heroicons/react/24/outline";
import {
  registerSchema,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Right Side - Blue Gradient Welcome Back */}
        <div className="md:w-1/2 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 p-12 flex flex-col items-center justify-center text-white relative overflow-hidden">
          {/* Decorative blobs */}
          <div className="absolute top-0 left-0 w-64 h-64 bg-white/10 rounded-full -translate-y-1/2 -translate-x-1/2"></div>
          <div className="absolute bottom-0 right-0 w-48 h-48 bg-white/10 rounded-full translate-y-1/2 translate-x-1/2"></div>
